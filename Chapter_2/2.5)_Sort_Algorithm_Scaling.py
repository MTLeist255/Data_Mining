# FIGURE 2.2)
#
# The scaling of the quicksort algorithm. Plotted for comparison are lines showing
# O(N) and O(N log N) scaling. The quicksort algorithm falls along the O(N log N)
# line, as expected.
...
ax.set_title("Figure 2.2) Scaling of Sort Algorithms")
