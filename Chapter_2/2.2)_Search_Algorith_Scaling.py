# FIGURE 2.1)
#
# The scaling of two methods to search for an item in an ordered list: a linear method
# which performs a comparison on all N items, and a binary search which uses a more
# sophisticated algorithm. The theoretical scalings are shown by dashed lines.
# THIS CHANGES THE PLOT EVERY ITERATION
...
# add text and labels
ax.set_title("Figure 2.1) Scaling of Search Algorithms")
