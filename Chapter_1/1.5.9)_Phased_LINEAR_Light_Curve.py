# FIGURE 1.7)
#
# An example of the type of data available in the LINEAR dataset. The scatter plots show the
# g-r and r-i colors, and the variability period determined using a Lomb-Scargle periodogram
# (for details see chapter 10). The upper-right panel shows a phased light curve for one of
# the over 7000 objects.
