# FIGURE 1.12):
#
# A multicolor scatter plot of the properties of asteroids from the SDSS
# Moving Object Catalog (cf. figure 1.8). The left panel shows observational
# markers of the chemical properties of the asteroids: two colors a* and i-z.
# The right panel shows the orbital parameters: semimajor axis a vs. the sine
# of the inclination. The color of points in the right panel reflects their
# position in the left panel. This plot is similar to that used in figures
# 3-4 of Parker et al 2008.
...
#------------------------------------------------------------
# set up the plot
fig = plt.figure(figsize=(7, 4), facecolor='k')
...
plt.title('Figure 1.12) SDSS Stripe 82\nMoving Object Catalog', color='w')
