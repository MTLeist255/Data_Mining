# FIGURE 3.7)
#
# This shows an example of a uniform distribution with various parameters. We’ll generate the distribution using:
#
# dist = scipy.stats.uniform(...)
#
# Where … should be filled in with the desired distribution parameters Once we have defined the distribution
# parameters in this way, these distribution objects have many useful methods; for example:
#
...
plt.title('Figure 3.7) Uniform Distribution')
