# FIGURE 3.8)
#
# This shows an example of a gaussian distribution with various parameters. We’ll generate the distribution using:
#
# dist = scipy.stats.norm(...)
#
# Where … should be filled in with the desired distribution parameters Once we have defined the
# distribution parameters in this way, these distribution objects have many useful methods; for example:
#
...
plt.title('Figure 3.8) Gaussian Distribution')
