# FIGURE 3.2) An example of 2D probability distribution. The color-coded panel
# shows p(x,y). The two panels to the left and below show marginal distributions
# in x and y (see eq 3.8). The three panels to the right show the conditional
# probability distributions p(x|y) (see eq 3.7) for three different values of y
# (as marked in the left panel) -> JOINT AND CONDITIONAL PROBABILITIES
