# FIGURE 3.4):
#
# An example of transforming a uniform distribution. In the left panel,
# x is sampled from a uniform distribution of unit width centered on
# x = 0.5 (\mu = 0 and W = 1; see Section 3.3.1). In the right panel,
# the distribution is transformed via y = exp(x). The form of the
# resulting pdf is computed from eq. 3.20.
