# FIGURE 3.6)
#
# An example of distributions with different skewness \Sigma (top panel)
# and kurtosis K (bottom panel). The modified Gaussian in the upper panel
# is a normal distribution multiplied by a Gram-Charlier series (see eq.
# 4.70), with a0 = 2, a1 = 1, and a2 = 0.5. The log-normal has \sigma = 1.2.
