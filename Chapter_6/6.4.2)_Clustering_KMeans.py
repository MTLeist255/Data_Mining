# FIGURE 6.13): Clustering by Sum-of-Squares Minimization: K-Means

# The K-means analysis of the stellar metallicity data used in figure 6.6. Note how the background distribution “pulls”
# the cluster centers away from the locus where one would place them by eye. This is why more sophisticated models like
...
# demo broken code 1st, then explain fix
...
#------------------------------------------------------------
# Compute a 2D histogram  of the input-> increase/decrease data
H, FeH_bins, alphFe_bins = np.histogram2d(data['FeH'], data['alphFe'], 50)

#------------------------------------------------------------
# Compute the KMeans clustering-> edit to add/subtract clusters
n_clusters = 4
